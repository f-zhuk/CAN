...
void _CO_COMM_NMT_Open(void)
{
 ...
 _uCANOldMode = CANCON; _uCAN_Handle = (0x00) | 1; *((unsigned long *)(&_uCAN_Param1)) = 0x00L; _CANOpenMessage(); _hNMT = _uCAN_ret;;


 if (_hNMT) _net_en.bits.b0 = 1;
}
# 105 "CANopen/CO_NMT.c"
void _CO_COMM_NMT_Close(void)
{

 _uCANOldMode = CANCON; _uCAN_Handle = _hNMT; _CANCloseMessage();;
 _net_en.bits.b0 = 0;
}
# 132 "CANopen/CO_NMT.c"
void _CO_COMM_NMT_RXEvent(void)
{
 ...
 if ((RXB0DLC & 0xF) == 2)
 {
  ...
  if ((RXB0D1 == _uCO_nodeID.byte) || (!RXB0D1))
  {
# 148 "CANopen/CO_NMT.c"
   switch(RXB0D0)
   {
    case 1:
     _uCO_state.bits.b1 = 1;
     _uCO_state.bits.b2 = 0;
     CO_NMTStateChangeEvent();
     break;
    case 2:
     _uCO_state.bits.b2 = 1;
     CO_NMTStateChangeEvent();
     break;
    case 128:
     _uCO_state.bits.b1 = 0;
     _uCO_state.bits.b2 = 0;
     CO_NMTStateChangeEvent();
     break;

    case 129:
     CO_NMTAppResetRequest();
