...
# 2 "<built-in>" 2
# 1 "CANopen/CO_NMTE.c" 2
# 49 "CANopen/CO_NMTE.c"
# 1 "CANopen/CO_DEFS.def" 1
# 49 "CANopen/CO_NMTE.c" 2
...
# 253 "CANopen/CO_NMTE.c"
void _CO_COMM_NMTE_Open(void)
{

 _uNMTE_COBID.word = 0x700L + _uCO_nodeID.byte;
 _uCOB_ID_in.word = _uNMTE_COBID.word; _CO_COB_CANopen2MCHP();;
 _uNMTE_COBID.word = _uCOB_ID_out.word;
 ...
 if (_uNMTEGuardTime.word && _uNMTELifeFactor.byte)
 {
  ...
  _uCANOldMode = CANCON; _uCAN_Handle = (0x00) | 4; *((unsigned long *)(&_uCAN_Param1)) = _uNMTE_COBID.word; _CANOpenMessage(); _hNMTE = _uCAN_ret;;
  if (_hNMTE)
  {
   _net_en.bits.b3 = 1;
...
# 307 "CANopen/CO_NMTE.c"
void _CO_COMM_NMTE_Close(void)
{

 _uCANOldMode = CANCON; _uCAN_Handle = _hNMTE; _CANCloseMessage();;
 _net_en.bits.b3 = 0;
}
# 333 "CANopen/CO_NMTE.c"
void _CO_COMM_NMTE_RXEvent(void)
{

 if (_uNMTEState.bits.b2)
 {
...
# 371 "CANopen/CO_NMTE.c"
void _CO_COMM_NMTE_TXEvent(void)
{
 {

  *(unsigned long *)((&RXB0SIDH)) = _uNMTE_COBID.word;
  ...
  if (!_uNMTEState.bits.b0)
  {

   _uNMTELocalState.byte = _uNMTELocalState.byte & 0x80;
   if (_uNMTEState.bits.b2) {_uNMTELocalState.bits.b7 = (~_uNMTELocalState.bits.b7);}
   else {_uNMTELocalState.bits.b7 = 0;}


   if (_uCO_state.bits.b2) _uNMTELocalState.byte = _uNMTELocalState.byte | 4;
   else
   if (_uCO_state.bits.b1) _uNMTELocalState.byte = _uNMTELocalState.byte | 5;
   else
   if (_uCO_state.bits.b0) _uNMTELocalState.byte = _uNMTELocalState.byte | 127;


   (RXB0D0 = _uNMTELocalState.byte);
  }
  else
  {
   _uNMTEState.bits.b0 = 0;
   (RXB0D0 = 0);
  }
 }
}
# 424 "CANopen/CO_NMTE.c"
void _CO_COMM_NMTE_LSTimerEvent(void)
{

 if (_uNMTEState.bits.b1)
 {
