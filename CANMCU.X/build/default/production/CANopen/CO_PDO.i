...
# 2 "<built-in>" 2
# 1 "CANopen/CO_PDO.c" 2
# 45 "CANopen/CO_PDO.c"
# 1 "CANopen/CO_DEFS.def" 1
# 45 "CANopen/CO_PDO.c" 2
...
# 49 "CANopen/CO_PDO.c" 2
# 62 "CANopen/CO_PDO.c"
UNSIGNED32 uRPDOComm1;
UNSIGNED32 uTPDOComm1;
_PDOBUF _uPDO1;
...
void _CO_COMM_PDO1_Open(void)
{
 ...
 _uCANOldMode = CANCON; _uCAN_Handle = (0x80) | 0; *((unsigned long *)(&_uCAN_Param1)) = uRPDOComm1.word; _CANOpenMessage(); _uPDOHandles1 = _uCAN_ret;;
 if (_uPDOHandles1) _rpdo_en.bits.b0 = 1;
}

void _CO_COMM_PDO1_Close(void)
{

 _uCANOldMode = CANCON; _uCAN_Handle = _uPDOHandles1; _CANCloseMessage();;
 _rpdo_en.bits.b0 = 0;
}

void _CO_COMM_PDO1_RXEvent(void)
{
 *((_DATA8 *)(_uPDO1.RPDO.buf)) = *((_DATA8 *)((&RXB0D0)));
 _uPDO1.RPDO.len = (RXB0DLC & 0xF);
}

void _CO_COMM_PDO1_TXEvent(void)
{

 *(unsigned long *)((&RXB0SIDH)) = uTPDOComm1.word;


 *((_DATA8 *)((&RXB0D0))) = *((_DATA8 *)(_uPDO1.TPDO.buf));
 (RXB0DLC = _uPDO1.TPDO.len);
}
