...
# 2 "<built-in>" 2
# 1 "CANopen/CO_CANDRV.c" 2
# 46 "CANopen/CO_CANDRV.c"
# 1 "CANopen/CO_DEFS.def" 1
# 46 "CANopen/CO_CANDRV.c" 2
...
unsigned char _uCAN_Bitrate;
unsigned char _uCANRxHndls[8];
_FILTER _uCANRxIDRes[8];
unsigned char _uCANTxHndls[3];

unsigned char _uCANReq;

unsigned char _uCANOldMode;
# 107 "CANopen/CO_CANDRV.c"
void _CANEventManager(void)
{
 if (_uCANReq)
 {
...
void _CANReset(void)
{
 ...
 _uCANRxHndls[7] = 0;
# 339 "CANopen/CO_CANDRV.c"
}
# 366 "CANopen/CO_CANDRV.c"
void _CANSetBitRate(void)
{
...
# 682 "CANopen/CO_CANDRV.c"
  else {_uCAN_ret = 0; PIR5bits.RXB1IF = 0; return;}
