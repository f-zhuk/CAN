...
# 2 "<built-in>" 2
# 1 "CANopen/CO_SYNC.c" 2
# 47 "CANopen/CO_SYNC.c"
...
# 85 "CANopen/CO_SYNC.c"
void _CO_COMM_SYNC_Open(void)
{

 _uCANOldMode = CANCON; _uCAN_Handle = 0x00 | 2; *((unsigned long *)(&_uCAN_Param1)) = _uSYNC_COBID.word; _CANOpenMessage(); _hSYNC = _uCAN_ret;;


 if (_hSYNC) _net_en.bits.b1 = 1;
}
# 110 "CANopen/CO_SYNC.c"
void _CO_COMM_SYNC_Close(void)
{

 _uCANOldMode = CANCON; _uCAN_Handle = _hSYNC; _CANCloseMessage();;
 _net_en.bits.b1 = 0;
}
# 134 "CANopen/CO_SYNC.c"
void _CO_COMM_SYNC_RXEvent(void)
{
...
void _CO_COMM_SYNC_COBIDAccessEvent(void)
{
 switch (uDict.cmd)
 {
  ...
  case DICT_OBJ_READ:
   ...
   _uCOB_ID_in.word = _uSYNC_COBID.word; _CO_COB_MCHP2CANopen();;
  ...
  case DICT_OBJ_WRITE:
   ...
   if ((*(UNSIGNED32 *)(&_uCOB_ID_out.word)).bytes.B1.bits.b2 == 0)
   {

    _CO_COMM_SYNC_Close();


    _uSYNC_COBID.word = _uCOB_ID_out.word;
